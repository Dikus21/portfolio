...
const ProjectCard = () => {
  return (
    <div className="w-[590px] flex flex-col gap-7 p-7 rounded-[20px] dark:bg-black bg-white">
      ...
      <div className="flex flex-col gap-3">
        ...
        <p className="text-xl text-textContent font-light text-justify">
          🏦 Banking should be simple, seamless, and accessible to everyone no
          exceptions. This app goes beyond just convenience, it’s built to
          remove barriers, ensuring that users of all abilities can manage their
      ...
      <button className="flex flex-row gap-2.5 px-2.5 py-1.5 bg-primary w-[120px] rounded-md">
        <svg
          width="25"
          height="25"
          viewBox="0 0 25 25"
        ...
        <p className="text-background">Source</p>
      </button>
    </div>
  );
};
